...
import port2 from "../essets/port2.png";
import cargo1 from "../essets/cargo1.png";
import cargo3 from "../essets/cargo3.png";
import cargo5 from "../essets/cargo5.png";
  ...
  return (
    <div className="achievemts-main-container">
      <div className="container py-2">
        <h1 className="text-center mb-3" style={{ color: "#FFD129" }}>
          ACHIEVEMENTS
        </h1>
        <div className="d-flex justify-content-center mb-4 align-items-center">
          ...
          />
          <button className="btn btn-primary mb-4 ms-2">Search</button>
        </div>
        {achievements.map((item, index) => (
          <div key={index} className="card mb-4 achievemts-section">
        ...
        <h3 className="ramayapatnam-title">RAMAYAPATNAM PORT</h3>
        ...
        <div className="card mb-4 achievemts-section">
          <div className="row g-0 align-items-center">
            ...
            <div className="col-md-6 col-12">
              <ImageGallery images={[port, cargo, cargo2, rail]} />
            </div>
          </div>
        </div>

        <h3 className="ramayapatnam-title">MSME Park</h3>

        <div className="card mb-4 achievemts-section">
          <div className="row g-0 align-items-center">
            <div className="col-md-6 col-12">
              <ImageGallery images={[park1, park2, park3, park4]} />
            </div>
        ...
        <h3 className="ramayapatnam-title">RAILWAY CARGO</h3>
        ...
        <div className="card mb-4 achievemts-section">
          <div className="row g-0 align-items-center">
            <div className="col-md-6 col-12">
              <div className="card-body">
                <ul>
                  <li>Improved rail connectivity for Kandukur.</li>
                  <li>Better logistics access for farmers.</li>
                  <li>Faster cargo transportation network.</li>
                  <li>Enhanced freight movement facilities.</li>
                  <li>Bulk handling, cold chain and logistics yards.</li>
                  <li>Growth through rail-road connectivity.</li>
                  <li>Continuous progress in Kandukur constituency.</li>
                </ul>
            ...
            <div className="col-md-6 col-12">
              <ImageGallery images={[port2, cargo1, cargo3, cargo5]} />
            </div>
          </div>
        </div>
      </div>
