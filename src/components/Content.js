...
import issuepic from "../essets/issuepic.png";
        ...
        <div className="container-content">
            <div className="container">
                ...
                <p className="content-subheading">
                    Join our mission to transform Kandukur through focused
                    initiatives that address the most pressing needs of our
                    community.
                </p>
                ...
                <div className="issue">
                    ...
                    <div className="issue-content">
                        ...
                        <p className="issue-text">
                            Reporting issues helps us prioritize our campaign
                            efforts and serve you better.
                        </p>
                    </div>
